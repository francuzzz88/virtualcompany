...
public class VirtualCompanyApplication {
    ...
    CommandLineRunner run(AppUserService userService){
        return args -> {
            ...
            userService.addNewUser(new AppUser(null, "user1", "1234","user1@email.ru",new ArrayList<>()));
            userService.addNewUser(new AppUser(null, "admin", "1234","admin@email.ru",new ArrayList<>()));
            userService.addNewUser(new AppUser(null, "user2", "1234","user2@email.ru",new ArrayList<>()));
